...
$productQuery = "SELECT product_id, name, price FROM Products";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["user_id"]) && isset($_POST["product_id"])) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        // Get the second result set which contains wishlist items
        $stmt->next_result();
        $wishlistResult = $stmt->get_result();
        
        if ($wishlistResult && $wishlistResult->num_rows > 0) {
                        ...
                        <table class="table table-hover">
                            ...
                            <tfoot>
                                <tr class="table-primary">
                                    <th>Subtotal</th>
                                    <th>$<?php echo !empty($wishlistItems) ? $wishlistItems[0]['subtotal'] : '0.00'; ?></th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
